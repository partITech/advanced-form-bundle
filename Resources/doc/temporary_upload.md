...
use Partitech\AdvancedFormBundle\Model\TemporaryUploadedFile as BaseUploadedFile;

/**
 * Class UploadedFile
 *
 * @ORM\Entity
 * @ORM\Table(name="partitech_afb_uploaded_file")
 */
...
Partitech_advanced_form:
    ...
    tmp_uploaded_file_dir: '%kernel.project_dir%/var/uploads/partitech_afb_tmp'
```

Just change the upload_mode in the form definition to use the temporary mode:
```php
<?php 
use Partitech\AdvancedFormBundle\Form\Type\FileType;
//...
$builder
