...
namespace Partitech\AdvancedFormBundle\Tests\Form\Type;

use Partitech\AdvancedFormBundle\Form\Type\KeyValueRowType;
use Partitech\AdvancedFormBundle\Form\Type\KeyValueType;
...
class KeyValueTypeTest extends TypeTestCase
{
        ...
        if (null === self::$isSf28) {
            ...
            if (self::$isSf28) {
                self::$typeNames = array(
                    ...
                    'partitech_key_value' => 'Partitech\AdvancedFormBundle\Form\Type\KeyValueType',
                );
            } else {
                self::$typeNames = array(
                    'choice' => 'choice',
                    'text' => 'text',
                    'partitech_key_value' => 'partitech_key_value',
                );
            }
        }
    }
    ...
    public function testSubmitValidData()
    {
        ...
        $form = $this->factory->create(
            self::$typeNames['partitech_key_value'],
            $originalData,
            array(
    ...
    {
        $form = $this->factory->create(self::$typeNames['partitech_key_value'], null, array(
            'key_type' => 'country',
            'value_type' => 'integer',
            'key_options' => array('label' => 'label_key'),
        ));
