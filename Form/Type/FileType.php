        ...
        $resolver->setDefaults([
            'upload_uri_path' => function (Options $options) {
                if ($options['upload_mode'] == 'temporary') {
                    $url = $this->urlGenerator->generate('partitech_afb_upload_tmp');
                } elseif ($options['upload_mode'] == 'immediate') {
                    $url = $this->urlGenerator->generate('partitech_afb_upload');
                } else {
                    $url = null;
                }
            ...
            'remove_uri_path' => $this->urlGenerator->generate('partitech_afb_remove'),
            'remove_tmp_uri_path' => $url = $this->urlGenerator->generate('partitech_afb_remove_tmp'),
            'js_callback' => null,
