...
use Partitech\AdvancedFormBundle\DependentEntity\DependentMapperPool;
...
class DependentEntityType extends AbstractType
{
    ...
    public function buildView(FormView $view, FormInterface $form, array $options)
    {
        ...
        if ($ajaxUrl === true) {
            ...
            $ajaxUrl = $this->router->generate('partitech_afb_dependent_results', ['mapper' => $options['mapping']]);
        }
