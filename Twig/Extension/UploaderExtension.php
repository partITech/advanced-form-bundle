...
namespace Partitech\AdvancedFormBundle\Twig\Extension;
...
class UploaderExtension extends AbstractExtension
{
    ...
    {
        return [
            new TwigFunction('partitech_afb_asset', [$this, 'getAsset']),
            new TwigFunction('partitech_afb_filename', [$this, 'getFilename']),
            new TwigFunction('partitech_afb_base_64_image', [$this, 'getImageBase64']),
        ];
    }
